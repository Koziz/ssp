                        ...
                        <div class="card-body">
                            ...
                            <input name="id" value="<?php echo $data['id_kelas']; ?>"  hidden />
                                <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="Data1" value="<?php echo $data['nama_kelas']; ?>" class="form-control col-md-4">
                                </div>
                                <div class="form-group mb-4">
                                        <div class="col-md-2 h6">Nominal</div>
                                        <input type="text" name="Data2" value="<?php echo $data['kompetensi_keahlian']; ?>" class="form-control col-md-4">
                                </div>
                                <div class="form-group mb-4">
                                        <input href="../spp.php" type="submit" class="btn btn-primary ">
                                        <a class="btn btn-primary " href="kelas.php" role="button">Back</a>
                                </div>
                            </div>
                        </div>
        </form>
